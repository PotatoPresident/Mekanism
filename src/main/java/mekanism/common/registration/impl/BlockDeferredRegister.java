...
public class BlockDeferredRegister extends DoubleDeferredRegister<Block, Item> {
    ...
    public <BLOCK extends Block, ITEM extends BlockItem> BlockRegistryObject<BLOCK, ITEM> registerDefaultProperties(String name, Supplier<BLOCK> blockSupplier,
    ...
    public <BLOCK extends Block, ITEM extends BlockItem> BlockRegistryObject<BLOCK, ITEM> register(String name, Supplier<BLOCK> blockSupplier,
